 ...
 *
 * @RestResource(
 *   id = "expose_specific_content_type_resource",
 *   label = @Translation("Expose Specific content type content."),
 *   uri_paths = {
 *     "canonical" = "/api/v1/content/{content_type}",
 *   }
 * )
 */
class ContentTypeResource extends ResourceBase {
  ...
  public function get($content_type) {
    $data = [];
    $nodes = $this->contentUtility->loadSpecificTypeNodes($content_type);
    if (empty($nodes)) {
